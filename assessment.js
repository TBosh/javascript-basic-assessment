...
var firstHero = heroes.slice(0,1).toString();
...
var secondHero = heroes.splice(3, 1).toString();
// leave batman in the array but put a copy of him on a variable called thirdHero
var thirdHero = heroes.slice(2, 3).toString();


// #9 Write a function called addItem 
//that takes in an array and an item, 
//adds the item to the array, 
//and returns the array with the added item.
var myGroceryList = ['bread', 'cheese', 'meat'];
var wants = 'soda';

function addItem() {
 	arr = ['bread', 'meat', 'cheese'];
	item = "soda";
	arr.push(item)
}
...
//If their name is Brack set lovesCode to 0.  
//otherwise set lovesCode to 5.

function coderTest(name) {
	person = {
		name: "Jeremy",
		lovesCode: 0
	}
